...
vignette: >
  %\VignetteIndexEntry{Workflow Deep Dive}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---


This vignette provides more details about the individual methods of the [`MRPWorkflow`](https://mrp-interface.github.io/shinymrp/reference/MRPWorkflow.html) objects and [`MRPModel`](https://mrp-interface.github.io/shinymrp/reference/MRPModel.html) objects, including their purposes, arguments, and caveats. For a more general overview of the classes, please refer to the ["Getting started with shinymrp"](https://mrp-interface.github.io/shinymrp/articles/getting-started.html) vignette.
