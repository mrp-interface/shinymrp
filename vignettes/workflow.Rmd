...
- `icar` (see [Besag et al., 1991](https://link.springer.com/article/10.1007/BF00116466))
- `bym2` (see [Riebler et al., 2016](https://pmc.ncbi.nlm.nih.gov/articles/PMC11874469/))
...
```{r, estimate_plot, opts.label="tall_plot", fig.width=13, fig.height=14}
