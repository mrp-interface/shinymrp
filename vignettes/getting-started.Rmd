...
- For a more detailed walk-through of each method, output interpretation, and recommended practices, see the [Programmatic workflow demonstration](https://mrp-interface.github.io/shinymrp/articles/workflow.html) vignette.
- For elaboration onß the theoretical background of MRP, see the [Methodological guide](https://mrp-interface.github.io/shinymrp/articles/method.html) vignette.
