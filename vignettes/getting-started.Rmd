...
- Once ready, follow the [CmdStanR installation instructions](https://mc-stan.org/cmdstanr/articles/cmdstanr.html#installing-cmdstan) to install CmdStan.


## Key steps

The **shinymrp** R6-based interface is ideal for users who want full scripting control and have high-performance computing resources. The workflow is object-oriented, with your main point of interaction being the `MRPWorkflow` object. This object provides methods for every stage of your analysis.
...
First, we preprocess a sample dataset and obtain poststratification data from the American Community Survey (ACS) or custom upload. Here’s an example using built-in sample data and linked ACS:
...
- For more details on input data requirements and preprocessing, see the vignette of [Data preprocessing](https://mrp-interface.github.io/shinymrp/articles/data-prep).
