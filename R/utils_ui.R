...
create_guide <- function() {
  ...
  bslib::accordion(
    ...
    bslib::accordion_panel(
      ...
      tags$h5("Spatio-temporal Data", class = "fw-bold mt-3"),
      tags$ul(
        tags$li("Sex: male, female"),
