  ...
  tagList(
    fluidRow(
      column(width = 6, offset = 3,
        ...
        tags$div(style = "margin-top: 40px",
          tags$h4("References"),
          tags$p(tags$a("Y Si, T Tran, J Gabry, M Morris, and A Gelman (2025), Multilevel Regression and Poststratification Interface: Application to Track Community-level COVID-19 Viral Transmission, Population Health Metrics (under review)", href = "http://arxiv.org/abs/2405.05909", target = "_blank"), "."),
          ...
          tags$p(tags$a("L Covello, A Gelman, Y Si, and S Wang (2021). Routine Hospital-Based SARS-CoV-2 Testing Outperforms State-Based Data in Predicting Clinical Burden, Epidemiology, 32(6), 792--799", href = "https://journals.lww.com/epidem/Fulltext/2021/11000/Routine_Hospital_based_SARS_CoV_2_Testing.4.aspx", target = "_blank"), "."),
