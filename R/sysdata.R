...
#’ - **`acs_covid_`**: A list containing the post-stratification table and covariates for COVID-19 data.
#’ - **`acs_poll_`**: A list containing the post-stratification table for polling data.
